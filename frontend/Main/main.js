...
function showMembers(peeps) {
  ...
  Btn1.addEventListener("click", function removeUser() {
    console.log(Child.id);
    axios.delete(`https://groupchat-app-gamma.vercel.app/RemoveMember/${Child.id}`).then(() => {
  ...
  Btn2.addEventListener("click", function MakeAdmin(e) {
    ...
    axios
      .post(`https://groupchat-app-gamma.vercel.app/MakeAdmin/${Child.id}/${Child.name}`, Admin, {
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  axios
  .get("https://groupchat-app-gamma.vercel.app/showMembers", {
    headers: { Authorisation: token },
  })
  .then((Response) => {
  ...
  setInterval(() => {
    ...
    axios
      .get(`https://groupchat-app-gamma.vercel.app/get-message?groupId=${groupId}`, {
        headers: {
          Authorisation: token,
        },
      })
    ...
    axios
      .get("https://groupchat-app-gamma.vercel.app/getGroupList", {
        headers: {
          Authorisation: token,
        },
      })
...
SendButton.addEventListener("click", function () {
  ...
  axios
    .post("https://groupchat-app-gamma.vercel.app/add-message", Text, {
      headers: { Authorisation: token },
    })
    .then((response) => {
      console.log(response);
